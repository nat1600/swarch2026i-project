...
public class UserGameSessionController {
    ...
    public ResponseEntity<BooleanDTO> deleteAllUserGameSessions(@RequestHeader("X-User-Sub") String userName) {
    ...
    public ResponseEntity<BooleanDTO> deleteAllUserGameSessionsPerDate(@RequestHeader("X-User-Sub") String userName, @RequestParam LocalDate intendedDate) {
    ...
    public ResponseEntity<List<UserGameSession>> getAllUserGameSessions(@RequestHeader("X-User-Sub") String userName) {
    ...
    public ResponseEntity<List<UserGameSession>> getAllUserGameSessionsPerDate(@RequestHeader("X-User-Sub") String userName, @RequestParam LocalDate intendedDate) {
    ...
    public ResponseEntity<List<UserGameSession>> getAllUserGameSessionsPerPoints(@RequestHeader("X-User-Sub") String userName, @RequestParam Integer intendedPoints) {
