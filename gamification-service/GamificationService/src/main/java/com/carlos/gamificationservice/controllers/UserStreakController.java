...
public class UserStreakController {
    ...
    public ResponseEntity<UserStreakDTO> postUserStreak(@RequestHeader("X-User-Sub") String userName) {
        try {
    ...
    public ResponseEntity<UserStreakDTO> getUserStreak(@RequestHeader("X-User-Sub") String userName) {
        try {
